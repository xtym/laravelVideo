...
@section('content')
    <form action="/admin/lesson" method="post" class="form-horizontal" role="form">
        ...
        <div class="panel panel-default container" style="width: 90%">
            ...
            <div class="panel-body">
                        ...
                        <div class="checkbox">
                            @foreach($tagData as $v)
                                <label class="checkbox-inline">
                                    <input type="checkbox" value="{{$v['id']}}" name="tid[]">
                                    {{$v['name']}}
                                </label>
                            @endforeach
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src="{{asset('/node_modules/hdjs/images/nopic.jpg')}}" class="img-responsive img-thumbnail" width="150">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="radio-inline">
                                <input type="radio" name="iscommend" id="inputID" value="1" checked="checked">
                                是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="iscommend" id="inputID" value="0">
                                否
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="radio-inline">
                                <input type="radio" name="ishot" id="inputID" value="1" checked="checked">
                                是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="ishot" id="inputID" value="0">
                                否
                            </label>
                        </div>
                    </div>
